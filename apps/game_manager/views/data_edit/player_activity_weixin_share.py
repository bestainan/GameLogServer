...
# 当前有用key
CUR_CON_STR_DIT = {
                    u"itemId": u'奖励物品：', u"stone": u'奖励钻石：',
                    u"gold": u'奖励金币：', u"freeDrop": u'奖励精灵球：',
                    u"star": u'道馆挑战星级要求：', u"power": u'玩家战力要求：',
                    u"playerLevel": u'玩家等级要求：', u"id": u'完成的奖励任务ID：',
                    u"stage": u'玩家副本要求：'
                    }
# 特殊处理的key
...
# templates player_activity_weixin_share.html
