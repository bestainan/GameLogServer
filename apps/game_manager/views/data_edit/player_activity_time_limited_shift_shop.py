...
CUR_CON_STR_DIT = {
                    u"id": u' @___兑换商城事件ID： ',
                    u"stoneNeed": u' 使用钻石： ', u'idItemNeed1': u' 使用物品1 ：',
                    u"goldNeed": u' 使用金币： ',   u'idItemNeed2': u' 使用物品2： ',
                    u"stoneGet": u' 兑换——钻石： ', u"goldGet": u' 兑换——金币： ', u"equipmentId": u' 兑换——装备： ',
                    u"idItemGet": u' 兑换——物品： ',
                    u"freeDrawGet": u' 兑换——精灵球： ', u"leftTimes": u' 可兑换次数：',
                  }
# 特殊处理的key
SPECIAL_CON_STR_LST = {u'idItemNeed1': u'numItemNeed1', u'idItemNeed2': u'numItemNeed2', u'idItemGet': u'numItemGet'}
...
# templates player_activity_time_limited_shift_shop.html
